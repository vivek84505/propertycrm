...
class StateModel extends Authenticatable
{
    ...
    public function getStatesAll(){
        ...
        $statedata = StateModel::select('state_id','state_name','createddate','createdby','lastmodifieddate','lastmodifiedby')->get()->toArray();
