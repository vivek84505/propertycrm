 ...
 <div class="sidebar-wrapper group">
      ...
      <div class="logo-segment">
        <a class="flex items-center" href="index.html">
          ...
          <span class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">DocProject</span>
        </a>
        <!-- Sidebar Type Button -->
      ...
      <div class="sidebar-menus bg-white dark:bg-slate-800 py-2 px-4 h-[calc(100%-80px)] overflow-y-auto z-50" id="sidebar_menus">
        ...
        <li  class="sidebar-menu-title">Document Master</li>
            ...
            <ul class="sidebar-submenu">
              <li>
                <a href="{{ route('marathidocument') }}">Marathi Document Wizard</a>
              </li>
